      ...
      <section className="poster-frame grid min-h-[calc(100vh-98px)] grid-cols-1 lg:grid-cols-[0.58fr_0.42fr]">
        <div className="grid-paper relative border-b-2 border-white p-5 lg:border-b-0 lg:border-r-2 lg:pl-24 lg:pr-8 lg:pt-8">
          ...
          <div className="flex items-start justify-between gap-6">
            ...
            <PageStamp index="02.">
              <LocalizedText en="Aix social run club" fr="Social run club Aix" />
            </PageStamp>
          </div>
          ...
          <div className="mt-5 grid grid-cols-[88px_1fr] border-2 border-dashed border-white p-4 font-mono uppercase">
            ...
            <div className="px-5">
              <p className="text-2xl font-bold">
                <LocalizedText en="MORE RUNS COMING SOON" fr="PLUS DE RUNS BIENTOT" />
              </p>
              <p className="mt-2 text-sm text-white/60">
                <LocalizedText en="Future events will appear here" fr="Les prochains evenements arriveront ici" />
              </p>
            </div>
          </div>
        </div>
        <aside className="grid-paper p-5 lg:p-8">
          ...
          <div className="mt-5 border-2 border-white p-5 font-mono uppercase">
            <p className="text-shock">
              <LocalizedText en="NEXT RUN RULES" fr="REGLES PROCHAIN RUN" />
            </p>
            <p className="mt-4 text-2xl font-black leading-tight">
              <LocalizedText en="Come as you are." fr="Viens comme tu es." />
              <br />
              <LocalizedText en="Leave less alone." fr="Repars moins seul." />
            </p>
            <p className="mt-4 text-sm text-white/65">
              <LocalizedText
                en="No gear check. No performance test. DJ sets after the run."
                fr="Pas de gear check. Pas de test de perf. DJ sets apres le run."
              />
            </p>
          </div>
          <div className="mt-5">
            <BrutalButton href="/contact" variant="pink">
              <LocalizedText en="ASK FOR THE NEXT RUN" fr="DEMANDER LE PROCHAIN RUN" />
            </BrutalButton>
          </div>
        </aside>
      </section>
      ...
      <div className="grid border-2 border-white md:grid-cols-[1fr_180px]">
        <div className="p-3">
          ...
          <dl className="mt-3 grid grid-cols-[92px_1fr] gap-y-1 font-mono text-xs uppercase">
            <dt>
              <LocalizedText en="Location:" fr="Lieu:" />
            </dt>
            <dd>Aix-en-Provence</dd>
            <dt>
              <LocalizedText en="Pace:" fr="Rythme:" />
            </dt>
            <dd>No ego</dd>
            <dt>
              <LocalizedText en="After:" fr="Apres:" />
            </dt>
            <dd>DJ sets</dd>
            <dt>
              <LocalizedText en="Rule:" fr="Regle:" />
            </dt>
            <dd>
              <LocalizedText en="Come as you are" fr="Viens comme tu es" />
            </dd>
