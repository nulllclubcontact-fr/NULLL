    ...
    <section className="shell grid gap-10 py-8 lg:py-12">
      <header>
        ...
        <h1 className="mt-4 font-display text-[clamp(2.4rem,6vw,4.2rem)] uppercase leading-[.95]">
          Vue d’ensemble<span className="text-[#C32986]">.</span>
        </h1>
      </header>
            ...
            {prochaines.map((c) => {
              ...
              return (
                <li className="flex flex-wrap items-center justify-between gap-4 border-2 border-[#773331] p-4" key={c.id}>
                  <div>
                    <Link className="font-display text-xl uppercase leading-none hover:text-[#C32986]" href={`/admin/courses/${c.id}`}>
                      {c.title}
                    </Link>
                ...
                return (
                  <tr className="border-b border-[#773331]/20" key={c.id}>
                    <td className="py-3 pr-4">
                      <Link className="font-bold hover:text-[#C32986]" href={`/admin/courses/${c.id}`}>
                        {c.title}
                      </Link>
                    </td>
