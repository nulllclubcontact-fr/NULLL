  ...
  return (
    <form className="flex flex-col gap-6" onSubmit={handleSubmit}>
      ...
      <label className="field-rule flex flex-col gap-3 pb-[3px] font-mono text-[.62rem] font-black uppercase tracking-[.16em] text-[#F1EDE9]/70 [word-spacing:.18em]">
        Ton email
        <input
          className="min-h-16 border-2 border-[#F1EDE9]/35 bg-transparent px-5 text-lg font-bold normal-case tracking-normal text-[#F1EDE9] outline-none transition-colors [word-spacing:normal] placeholder:text-[#F1EDE9]/35 focus:border-[#D3ED66] focus:bg-[#F1EDE9]/5"
          disabled={etat === "envoi"}
          name="email"
      ...
      <label className="field-rule flex flex-1 flex-col gap-3 pb-[3px] font-mono text-[.62rem] font-black uppercase tracking-[.16em] text-[#F1EDE9]/70 [word-spacing:.18em]">
        Ton message
        <textarea
          className="min-h-48 flex-1 resize-y border-2 border-[#F1EDE9]/35 bg-transparent px-5 py-4 text-lg font-bold normal-case leading-snug tracking-normal text-[#F1EDE9] outline-none transition-colors [word-spacing:normal] placeholder:text-[#F1EDE9]/35 focus:border-[#D3ED66] focus:bg-[#F1EDE9]/5"
          disabled={etat === "envoi"}
          name="message"
      ...
      <button
        className="inline-flex min-h-20 w-full items-center justify-between gap-4 border-2 border-[#D3ED66] bg-[#D3ED66] px-6 font-mono text-xs font-black uppercase tracking-[.1em] text-[#773331] transition-colors [word-spacing:.12em] hover:bg-transparent hover:text-[#D3ED66] focus-visible:outline-4 focus-visible:outline-offset-4 focus-visible:outline-[#F1EDE9] disabled:cursor-not-allowed disabled:opacity-60 disabled:hover:bg-[#D3ED66] disabled:hover:text-[#773331] sm:px-8"
        disabled={etat === "envoi"}
        type="submit"
      >
      ...
      <p aria-live="polite" className="min-h-6 text-base leading-relaxed">
        {etat === "envoye" ? (
          <span className="font-bold text-[#D3ED66]">C’est parti. On te répond à cette adresse.</span>
        ) : null}
        {etat === "erreur" ? <span className="font-bold text-[#C32986]">{erreur}</span> : null}
      </p>
    </form>
  );
}
