        ...
        >
          {copy.nav.map((item: { key: RouteKey; label: string }) => (
            <Link
              ...
              className={`grid place-items-center border-r-2 border-[#773331] px-2 text-center transition hover:bg-[#EBA0CD] focus-visible:bg-[#EBA0CD] focus-visible:outline-4 focus-visible:outline-offset-[-4px] focus-visible:outline-[#773331] ${
                item.key === current ? "bg-[#EBA0CD]" : ""
              }`}
      ...
      <div className="mx-auto max-w-[1600px] px-5 py-10 sm:px-8 sm:py-14 xl:px-12">
        <div className="grid gap-10 sm:grid-cols-2 lg:grid-cols-[1.5fr_1fr_1fr_1fr] lg:gap-12">
          <div>
            ...
            <p className="mt-4 max-w-xs leading-relaxed text-[#F1EDE9]/70">
...
export function HeroPanel({
  ...
  return (
    <section className="mx-auto grid w-full max-w-[1600px] gap-6 px-5 py-8 sm:px-8 xl:grid-cols-[minmax(0,1fr)_minmax(360px,0.68fr)] xl:px-12 xl:py-12">
      ...
      <div className="overflow-hidden border-2 border-[#773331] bg-[#773331] p-3">
