...
export function CommunityPageView({ locale }: { locale: Locale }) {
  ...
  return (
    <SiteShell current="community" locale={locale} pathname={getRoute(locale, "community")}>
      ...
      <section className="border-b-2 border-[#773331] bg-[#3A1A18] text-[#F1EDE9]" aria-labelledby="club-title">
        <div className="mx-auto grid max-w-[1600px] gap-12 px-5 pb-16 pt-14 sm:px-8 sm:pb-24 sm:pt-20 lg:grid-cols-[1.05fr_.95fr] lg:items-center lg:gap-16 xl:px-12">
          ...
          <figure className="hero-rise relative mx-auto w-full max-w-sm lg:mx-0 lg:max-w-none" style={{ animationDelay: "220ms" }}>
            ...
            <div className="relative aspect-[4/5] overflow-hidden border-2 border-[#F1EDE9] shadow-[14px_14px_0_#EBA0CD]">
              <Image
      ...
      {/* ---------------- LA LIGNE DE VIE ---------------- */}
      <section className="border-t-2 border-[#773331] bg-[#3A1A18] text-[#F1EDE9]" aria-labelledby="club-timeline">
        <div className="mx-auto w-full max-w-[1600px] px-5 py-16 sm:px-8 sm:py-24 xl:px-12">
          <p className="font-mono text-xs font-black uppercase tracking-[.16em] text-[#EBA0CD]">D’où ça vient</p>
      ...
      {/* ---------------- LES TROIS L ---------------- */}
      <section className="border-t-2 border-[#773331] bg-[#F1EDE9] text-[#773331]" aria-labelledby="club-letters">
        <div className="mx-auto max-w-[1600px] px-5 py-16 sm:px-8 sm:py-24 xl:px-12">
          <div className="flex flex-col gap-5 border-b-2 border-[#773331] pb-8 lg:flex-row lg:items-end lg:justify-between">
            <h2 className="max-w-[14ch] font-display text-[clamp(2.4rem,5vw,4.6rem)] uppercase leading-[1.12] tracking-[-.03em]" id="club-letters">
              {page.lettersTitle}
            </h2>
          ...
          <ol className="mt-12 grid gap-px bg-[#773331] md:grid-cols-3">
            {page.letters.map((item, index) => (
              <Reveal as="li" className="flex flex-col bg-[#F1EDE9] px-6 py-8 sm:px-8 sm:py-10" delay={index * 110} key={item.word}>
                <p aria-hidden="true" className="font-display text-[clamp(2.6rem,5vw,4.4rem)] uppercase leading-[1.12] tracking-[-.02em]">
                  {"NULLL".split("").map((lettre, position) => (
                    <span
                      className={position === item.highlight ? "text-[#C32986]" : "text-[#773331]/22"}
                      key={position}
                    >
                      {lettre}
                    </span>
          ...
          <div className="mt-14 border-t-2 border-[#773331] pt-8">
            <div>
      ...
      {/* ---------------- ÉDITORIAL ---------------- */}
      <section className="border-t-2 border-[#773331] bg-[#773331] text-[#F1EDE9]" aria-labelledby="club-editorial">
        <div className="mx-auto w-full max-w-[1600px] px-5 py-16 sm:px-8 sm:py-24 xl:px-12">
          <h2 className="max-w-[20ch] font-display text-[clamp(2.2rem,4.4vw,4rem)] uppercase leading-[1.12] tracking-[-.03em]" id="club-editorial">
            {page.editorialTitle}
          </h2>
      ...
      <section className="border-t-2 border-[#773331] bg-[#D3ED66] text-[#773331]" aria-labelledby="club-faq">
        <div className="mx-auto max-w-[1600px] px-5 py-16 sm:px-8 sm:py-24 xl:px-12">
          ...
          <dl className="mt-12 border-t-2 border-[#773331]">
      ...
      <section className="border-t-2 border-[#773331] bg-[#3A1A18] text-[#F1EDE9]" aria-labelledby="club-cta">
        <div className="mx-auto grid max-w-[1600px] gap-10 px-5 py-16 sm:px-8 sm:py-24 lg:grid-cols-[1.1fr_.9fr] lg:items-center lg:gap-16 xl:px-12">
          <div>
            <p className="font-mono text-xs font-black uppercase tracking-[.16em] text-[#EBA0CD]">{page.social.kicker}</p>
          ...
          <a
            className="social-card group relative flex flex-col justify-between gap-10 overflow-hidden border-2 border-[#F1EDE9]/30 p-7 focus-visible:outline-4 focus-visible:outline-offset-4 focus-visible:outline-[#EBA0CD] sm:p-9"
          ...
          >
            ...
            <span className="relative font-mono text-xs font-black uppercase tracking-[.16em] text-[#F1EDE9]/70">{page.social.title}</span>
            <span className="relative">
              <span className="block font-display text-[clamp(2rem,3.4vw,3rem)] uppercase leading-none">{copy.contact.instagramLabel}</span>
              <span className="mt-5 inline-flex items-center gap-4 border-2 border-[#F1EDE9] px-5 py-3 font-mono text-xs font-black uppercase tracking-[.12em] transition-colors group-hover:bg-[#F1EDE9] group-hover:text-[#773331]">
                {page.social.cta}
